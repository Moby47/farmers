     ...
     <!-- Navigation -->
       ...
       <div class="graphs">
        ...
        @include('layouts.error')
                ...
                <form method="POST" action="" id='formAd'>
                {{csrf_field()}}
                        <label>First Name </label>
                        <input type="text" class="form-control1 control3"   name='Name' value="{{ old('Name') }}">

                        <label>Email </label>
                        <input type="email" class="form-control1 control3" name='Email' value="{{ old('Email') }}">

                        <label>Phone Number </label>
                        <input type="text" class="form-control1 control3 numval" name='Number' value="{{ old('Number') }}">
                    <p class='numerr text-danger'></p>

                         <label>School </label>
                         <select class="form-control1 control3 selectpicker show-tick" data-live-search="true" name='School'>
...
<option value="UNIVERSITY OF NIGERIA ENUGU CAMPUS"> UNIVERSITY OF NIGERIA, ENUGU CAMPUS </option> 
                        ...
                        <input type="password" class="form-control1 control3" name='password' id="password" >

                        <label>Retype Password </label>
                        <input type="password" class="form-control1 control3" name="password_confirmation" id="password-confirm" >
                         
                        
                        <hr>
                        <button class="btn btn-warning btn-warng1 make"><span class="glyphicon glyphicon-plus tag_02 load"></span> Create </button>
