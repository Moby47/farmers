								...
								<h4 class="text-center">{{$count}} Result(s) Found for {{$word}} 
					   ...
					   <div>
						...
						<ul class="list">
							...
							<a href="/buy-product/{{str_replace(' ','-',$pp->title)}}">
								...
								@else
								<button class='btn aqua white message3xx up'  data-userids="{{$pp->user_id}}" data-titles="{{$pp->title}}" data-myids="{{Auth()->user()->id}}" data-names="{{Auth()->user()->name}}" >Chat</button>
								@endif
								@endif
...
<div class="container">
  ...
  <!-- ...........................message modal....................-->	
				...
				<script>
						...
						$.ajax({
							url: '/post-by-school?Search='+query+'&page='+ page,
